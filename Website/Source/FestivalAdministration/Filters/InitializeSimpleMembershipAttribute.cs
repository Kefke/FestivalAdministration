...
namespace FestivalAdministration.Filters
{
	...
	public sealed class InitializeSimpleMembershipAttribute : ActionFilterAttribute
	{
		...
		private class SimpleMembershipInitializer
		{
			...
			{
                Database.SetInitializer<MySqlSimpleMembershipDbContext>(null);

				try
				{
                    using (var context = MySqlSimpleMembershipDbContext.CreateContext())
					{
                    ...
                    MySqlWebSecurity.InitializeDatabaseConnection("SimpleMembershipConnectionString");
